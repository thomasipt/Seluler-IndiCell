...
Private Sub TOTAL()
If CCur(Text3) > CCur(Text4) Then
    Text6 = CCur(Text3) - CCur(Text4)
ElseIf CCur(Text3) < CCur(Text4) Then
    Text6 = CCur(Text4) - CCur(Text3)
ElseIf CCur(Text3) = CCur(Text4) Then
    Text6 = 0
End If
End Sub
...
Crpt.ReportFileName = "C:\WINDOWS\ReportSELULER\DafVC.rpt"
...
With grid
    ...
    .Col = 4: .ColWidth(4) = 1000: .Text = "UNIT": .CellAlignment = 4
    .Col = 5: .ColWidth(5) = 1250: .Text = "LABA": .CellAlignment = 4
End With
End Sub
   ...
   Do Until RCari.EOF
      ...
      grid.Row = B
         With grid
              ...
              .Col = 5: .Text = Format(RCari("LABA"), "##,###.00")
         End With
      B = B + 1
      RCari.MoveNext
   Loop
...
Else
    ...
    If Text3 = "" Or Text6 = "" Or Text4 = "" Then Exit Sub
    Text5 = Format(CCur(Text3) - (CCur(Text4) * CCur(Text6) / 100), "##,###.00")
End If
End Sub
