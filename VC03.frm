            ...
            If RSave4.RowCount <> 0 Then
                ...
                RSave4("Saldo") = CCur(SALDO) + CCur(SkinLabel7)
                    ...
                    Set RSave3 = Nothing
                        ...
                        SSave10 = "Select * From G006"
                        Set RSave10 = RDCO.OpenResultset(SSave10, rdOpenKeyset, rdConcurRowVer)
                        RSave10.AddNew
                            RSave10("Tgl") = Date
                            RSave10("Keterangan") = "JL.VC. " + Trim(Text1)
                            RSave10("HPP") = CCur(Text8)
                            RSave10("PDPT") = 0
                            RSave10("OP") = 0
                        RSave10.Update
                        RSave10.Close
...
If RCari2.RowCount <> 0 Then
    ...
    Text7 = Format(RCari2("HARGA"), "##,###.00")
    SkinLabel6 = Format(RCari2("UNIT"), "##,###")
    KB = RCari2("INDUK")
    Text8 = Format(RCari2("LABA"), "##,###.00")
