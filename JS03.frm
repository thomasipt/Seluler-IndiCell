...
If RSave.RowCount <> 0 Then
    RSave.Edit
    RSave("MutasiC") = CCur(Text30) + CCur(Text12)
    RSave("Saldo") = CCur(Text32) - CCur(Text12)
    ...
    RSave2.AddNew
        ...
        RSave2("Keterangan") = "PELUNASAN.SVC.NOTA " + Trim(Text1)
        RSave2("NominalD") = 0
        RSave2("NominalC") = CCur(Text12)
        RSave2("Saldo") = CCur(Text32) + CCur(Text12)
        RSave2("Tanggal") = Date
        RSave2("Jam") = Time
        RSave2("UserCode") = Operator
        RSave2("LABA") = CCur(Text3)
    RSave2.Update
    RSave2.Close
    Set RSave2 = Nothing
        ...
        RSave3.AddNew
            RSave3("Tgl") = Date
            RSave3("Keterangan") = "PELUNASAN.SVC.NOTA " + Trim(Text1)
            RSave3("HPP") = CCur(Text3)
            RSave3("PDPT") = 0
            RSave3("OP") = 0
        RSave3.Update
        RSave3.Close
...
With grid4
    ...
    .Col = 0: .ColWidth(0) = 500: .Text = "KODE": .CellAlignment = 4
    .Col = 1: .ColWidth(1) = 1500: .Text = "NAMA": .CellAlignment = 4
    .Col = 2: .ColWidth(2) = 1250: .Text = "BIAYA": .CellAlignment = 4
End With
End Sub
