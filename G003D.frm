...
Begin VB.Form G003D 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   7050
      OleObjectBlob   =   "G003D.frx":0000
      Top             =   4320
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   240
      Left            =   270
      OleObjectBlob   =   "G003D.frx":0234
      TabIndex        =   8
      Top             =   210
      Width           =   1590
   End
...
Else
    ...
    If RSave.RowCount <> 0 Then
        ...
        Set RSave2 = Nothing
            ...
            RSave3.AddNew
                RSave3("Tgl") = Date
                RSave3("Keterangan") = Trim(Text3)
                RSave3("HPP") = 0
                RSave3("PDPT") = CCur(Text2)
                RSave3("OP") = 0
            RSave3.Update
            RSave3.Close
            Set RSave3 = Nothing
