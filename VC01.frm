...
Private Sub LapVC3()
Crpt.ReportFileName = "C:\WINDOWS\ReportSELULER\LapVC3.rpt"
...
With grid
    ...
    .Col = 2: .ColWidth(2) = 500: .Text = "%": .CellAlignment = 4
End With
End Sub
   ...
   Do Until RCari.EOF
      ...
      grid.Row = B
         With grid
              ...
              .Col = 2: .Text = RCari("PERSEN"): .CellAlignment = 4
         End With
      B = B + 1
      RCari.MoveNext
   Loop
